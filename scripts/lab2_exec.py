...
def camera_callback(msg):
    ...
    global global_image
    try:
	    global_image = bridge.imgmsg_to_cv2(msg, "bgr8")                    
...
def main():
    ...
    camera_data = rospy.Subscriber('cv_camera_node/image_raw', Image, camera_callback) #############
    ############## Your Code Start Here ##############
    ...
    ############## Your Code Start Here ##############
    # TODO: modify the code so that UR3 can move tower accordingly from user while(1):
